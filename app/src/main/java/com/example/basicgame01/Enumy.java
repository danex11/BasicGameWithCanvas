...
public class Enumy {
    ...
    public Enumy(Context context, int screenX, int screenY, int plrXpos, int plrYpos) {
        //getting bitmap from drawable resource
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.player20red);
